module "deployment_pipeline" {
  source                      = "s3::https://s3.amazonaws.com/medly-dev-build-artifacts/terraform-modules/terraform-aws-deployment-pipeline-for-service/v1.0.3.zip"
  env                         = var.env
  ...
  tags                        = module.labels_for_deployment_pipeline.tags
}
